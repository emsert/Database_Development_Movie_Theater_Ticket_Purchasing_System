...
7. Identify suspicions reviews. Suspicious reviews are those:
	1) Very short (no more than x characters long where x is input and with extreme scores (1 or 5); or 
	2) The reviewer has never purchased any tickets for shows at the reviewed cinema. 
	For example, if reviewer A has left a review for cinema X. But only users B, C, and D have purchased tickets at X (they have transactions with shows at X), then A's review for X is fake. Print out review id and reason for fake review.
